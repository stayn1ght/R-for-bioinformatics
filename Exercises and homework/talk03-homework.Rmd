...
read.table("data/Table1.txt", header = FALSE)
read.table("data/Table2.txt", header = FALSE)
read.table("data/Table3.txt", header = FALSE)
read.table("data/Table4.txt", header = FALSE)
read.table("data/Table5.txt", header = FALSE)
read.table("data/Table6.txt", header = FALSE)
read.csv("data/states1.csv", header = FALSE)
